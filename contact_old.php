                    ...
                    <div class="row g-3">
                        ...
                        <!-- <div class="col-md-6">
                            <div class="form-floating">
                                ...
                                <div id="mobile_error" class="error hidden">Please enter a valid mobile number</div>
                            </div>
                        </div> -->
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <select class="form-control border border-dark" id="services" name="services">
                                    ...
                                    <option value="Service 1">Baby name correction</option>
                                    <option value="Service 2">Lucky name correction</option>
                                    <option value="Service 3">Lucky date delivery</option>
                                    <option value="Service 3">Name analysis</option>
