    ...
    <div class="d-flex flex-row justify-content-space-between">
      <div class="container-fluid">
        ...
        <div class="col-md-4 " >
          ...
          <!-- <div class="col-md-2 col-12 footer-widget1">
            <h3 style="font-size:20px;color:white;" class="pb-2">Get in touch</h3>
            <p style="font-size:18px;color:white">Number 664, 5 ft Cross, 4th block, Koramangala, Near maharaja signal, Bengaluru – 560034</p>
          </div> -->
         
          <div class="col-md-4  col-12 ">
            <img src="images/final-logo.png" class="img-fluid" alt="Logo" style="height:80px;width:300px;">
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
    <center>
        <a href="https://www.facebook.com/sheelaabajajm" style="color:#595959;font-size:13px;padding-right:10px;padding-left:0px;" target="_blank"><i class="fab fa-facebook-f" style="color:#595959;"></i></a>
        <a href="https://www.twitter.com/c/SheelaaMBajaj/" style="color:#595959;font-size:13px;padding-right:10px;" target="_blank"><i class="fab fa-twitter" style="color:#595959;"></i></a>
        <a href="https://www.instagram.com/sheelaambajaj/" style="color:#595959;font-size:13px;padding-right:10px;" target="_blank"><i class="fab fa-instagram" style="color:#595959;"></i></a>
        <a href="https://www.youtube.com/c/SheelaaMBajajOfficial" style="color:#595959;font-size:13px;padding-right:10px;" target="_blank"><i class="fab fa-youtube" style="color:#595959;"></i></a>
    </center>
</div>
          <div class="col-md-3"></div>
          </div>
