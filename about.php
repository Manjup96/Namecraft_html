   ...
   <section class="tedx_talk" style="background-color:#eee5ef;">
    <div class="container pb-5">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-lg-5  text-center pt-1">
                <div class="pt-5">
...
<section class="carousel-section" >
  ...
  <h3 class="custom-heading" style="font-weight:bold;color:white;text-align:center;">
    <i class="fas fa-gift" style="font-size: 48px;margin-bottom: 20px;"></i><br>
    HOLISTIC TRANSFORMATION
  </h3> <br>
  <p style= "text-align:center;font-family :montserrat;color: white;font-weight:;font-size;16px;">
    Our focus goes beyond a mere name change; we aim to facilitate holistic transformation in your life. By aligning your name with the principles of numerology, we strive to bring harmony and balance to various aspects of your life, including career, relationships, health, and overall well-being.
      ...
      <div class="owl-item why_choose_box">
         ...
         <h3 class="custom-heading" style="font-weight:bold;color:white;text-align:center;">
   <i class="fa-solid fa-hand-holding" style="font-size: 48px;margin-bottom: 20px;"></i><br>
    PERSONALIZED APPORACH</h3> <br>
    <p style= "text-align:center;font-family :montserrat;color: white;font-weight:;font-size;16px;"> At Namecraft, we recognize that each individual is unique, and their name correction needs should be treated with utmost care and customization. The result is a meticulously crafted name that resonates with your true essence and enhances your positive vibrations</P><br>
  ...
  $(document).ready(function() {
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xs-12 col-lg-8">
                <div class="text pt-5">
                    <h2 bold>AT NAMECRAFT</h2>
                    <p style="text-align:justify; font-family :montserrat;font-size:16px;color:blod;"class="text pt-4">At Namecraft, we have built on Sheelaa’s legacy by bringing her knowledge to institutions, helping them make informed decisions about names and other numerology-based services. We understand the importance of choosing the right name for a child, as it can have a significant impact on their life and future. Our numerology reports are based on a combination of traditional numerology principles and modern scientific research, ensuring accuracy and reliability.</p>
                    <p style="text-align:justify; font-family :montserrat;font-size:16px;"class="text pt-2">We work closely with maternity hospitals to understand their requirements and provide customized reports that are easy to understand and implement. We also offer a wide range of other numerology-based services, such as business name analysis, Lucky name numerology, and movie name numerology to help organizations achieve their goals.</p>
                    <p style="text-align:justify; font-family :montserrat;font-size:16px;"class="text pt-2">At Namecraft, we are committed to providing exceptional service and support to our clients. We believe in building long-term relationships with our clients, and we are always available to answer any questions or provide additional guidance. We are constantly exploring new ways to enhance our services and improve the experiences of our clients.</p>
                    <p style="text-align:justify; font-family :montserrat;font-size:16px;"class="text pt-2">Thank you for considering Namecraft for your numerology needs. We look forward to working with you and helping you achieve your goals.</p>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4 col-sm-6 col-12 text-center pt-4">
                <img src="images/sheela-9.png" alt="Image 3" class="img-fluid border rounded border-dark">
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-4 col-sm-6 col-12 text-center pt-4">
                <img src="images/sheela-6.png" alt="Image 4" class="img-fluid border rounded border-dark">
            </div>
            <div class="col-md-4 col-sm-6 col-12 text-center pt-4">
                <img src="images/sheela-8.png" alt="Image 5" class="img-fluid border rounded border-dark">
            </div>
            <div class="col-md-4 col-sm-6 col-12 text-center pt-4">
                <img src="images/sheela-7.png" alt="Image 6" class="img-fluid border rounded border-dark">
            </div>
        </div>
    </div>
