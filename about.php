...
<section class="tedx_talk" style="background-color:#eee5ef;">
    ...
    <div class="row">
        <div class="col-md-12 text-center pt-5">
            <h2  style=" letter-spacing: 8px; font-weight: ;">VIDEO & PRESENTATIONS</h2>
        </div>
    </div>
    <div class="row">
 ...
 <!-- Video Section Starts -->
    ...
    border-radius: 15px; /* Adjust the radius value to control the curve */
    overflow: hidden; /* Clip the curved border */
  }
        </style>
