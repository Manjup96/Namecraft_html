...
<div class="container-fluid p-0" style="margin-top:110px;">
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <img src="images/numbers/7.jpg" class="d-block w-100" alt="..." style="image-rendering: auto;">
            <div class="carousel-caption">
                <h5>NUMBER 7</h5>
                <p style="font-size: 9px">
                    <i class="fa fa-calendar"></i>&nbsp;JUNE 7, 2023&nbsp;&nbsp;&nbsp;&nbsp;
                    <span class="fa fa-user"></span>&nbsp;Sheelaa M Bajaj
                </p>
                <p><a id="num7" href="index.php">Home</a> / Number 7</p>
            </div>
        </div>
    </div>
</div>
