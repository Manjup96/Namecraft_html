...
<?php
  ...
  <style>
  .number7 .container-fluid {
    background-image: url("images/numbers/7.jpg");
...
<div class="number7">
  <div class="container-fluid">
    ...
    <p><a class="link" href="#index.php">HOME / NUMBER 7</a></p>
    </div>
    </div>
  </div>
</div>
...
<div class="form">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <p1 style="font-family:'Montserrat';font-size;16px;">Leave a Reply</p1>
