...
<div class="container-fluid p-0" style="margin-top:110px;">
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <img src="images/numbers/8.jpg" class="d-block w-100" alt="..." style="image-rendering: auto;">
            <div class="carousel-caption">
                ...
                <p><a id="num8" href="index.php">Home</a> / Number 8</p>
            </div>
        </div>
    </div>
</div>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-between">
            <a href="number7.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> PREVIOUS POST </a>
            <a href="number9.php" class="btn btn-secondary">NEXT POST <i class="fas fa-arrow-right"></i></a>
        </div>
    </div>
</div>
      </div>
