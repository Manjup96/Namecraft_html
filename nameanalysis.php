...
<div class="tabPanel">
<h2><b style=" font-family:montserrat; float: left;padding-left:30px;">Reviews</b></h3>
          <div class="p-5">
            ...
            <p style="text-align: justify; font-size: 16px; font-family:montserrat;"> YOUR REVIEW *</p>
                <input type="message" class="form-control" id="specific instruction"  name="specific instruction">
                    ...
                    <input type="checkbox" id="myCheckbox" name="myCheckbox">
                     <label for="myCheckbox"><p style="text-align: justify; font-size: 16px; font-family:montserrat;">
