...
<div class="container">
  <div class="row">
    <div class="col-lg-4 col-md-6 col-sm-6 text-center" style="margin-top: 50px">
      <a href="babyname.php">
        <div class="image-container">
          <img src="images/babyname numerology.jpg" class="img-fluid" style="width: 350px; height: 350px;">
          <div class="overlay">
            <div class="content">
    ...
    <a href="luckydate.php">
        <div class="image-container">
            <img src="images/C section delivery date.jpg" class="img-fluid" style="width: 350px; height: 350px;">
            <div class="overlay">
                <div class="content">
                    <p style="margin-top: 10px;">Select option</p>
                </div>
...
<div class="col-lg-4 col-md-6 col-sm-6 text-center" style="margin-top: 50px">
    <a href="luckyname.php">
        <div class="image-container">
            <img src="images/LUCKY ALPHABETS.jpg" class="img-fluid" style="width: 350px; height: 350px;">
            <div class="overlay">
                <div class="content">
                    <p style="margin-top: 10px;">Select option</p>
                </div>
...
<div class="col-lg-4 col-md-6 col-sm-6 text-center" style="margin-top: 50px">
    <a href="nameanalysis.php">
        <div class="image-container">
            <img src="images/Name analysis.jpg" class="img-fluid" style="width: 350px; height: 350px; ">
            <div class="overlay">
                <div class="content">
                    <p style="margin-top: 10px;">Select option</p>
                </div>
